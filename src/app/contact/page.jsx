...
// //           <div className="mx-auto max-w-6xl px-4 py-16 md:px-6 md:py-20 text-center">
...
// //           {/* Floating backdrop blur glow (optional) */}
...
// //                   </svg>
// //                   <div>
// //                     <p className="text-sm font-medium text-slate-900">Ring us up</p>
// //                     <a
...
// //                   </svg>
// //                   <div>
// //                     <p className="text-sm font-medium text-slate-900">Write to us</p>
// //                     <a
        ...
        <section className="mx-auto -mt-10 max-w-6xl px-4 pb-16 md:px-6">
          <div className="rounded-2xl bg-white/90 shadow-xl ring-1 ring-black/5 backdrop-blur">
            <div className="grid grid-cols-1 gap-6 p-5 md:p-8 lg:grid-cols-2">
              ...
              <div className="flex flex-col justify-center gap-6">
                ...
                <div className="flex items-start gap-4 rounded-xl border border-slate-200 p-5">
                  ...
                  <div>
                    ...
                    <a
                      href={`tel:${CONTACT.phone.replace(/[^0-9+]/g, "")}`}
                      className="mt-1 block text-sm text-slate-700 hover:text-blue-700 hover:underline"
                    >
                      {CONTACT.phone}
                    </a>
                  </div>
                ...
                <div className="flex items-start gap-4 rounded-xl border border-slate-200 p-5">
                  ...
                  <div>
                    ...
                    <a
                      href={`mailto:${CONTACT.email}`}
                      className="mt-1 block break-all text-sm text-slate-700 hover:text-blue-700 hover:underline"
                    >
                      {CONTACT.email}
                    </a>
                  </div>
              ...
              {/* Right: Two address cards (New Delhi + Noida) */}
              <div className="flex flex-col gap-4">
                ...
                <div className="rounded-xl border border-slate-200 p-5">
                  ...
                  <address className="mt-1 not-italic text-sm text-slate-700">
                    A-178, Shop No. 2, Ground Floor, Ganesh Nagar,<br />
                    Tilak Nagar, New&nbsp;Delhi-110018
                  </address>
                </div>

                {/* Noida branch (as provided, address is in New Ashok Nagar, Delhi) */}
                <div className="rounded-xl border border-slate-200 p-5">
                  <p className="text-sm font-semibold text-slate-900">
                    Branch Office — Noida
                  </p>
                  <address className="mt-1 not-italic text-sm text-slate-700">
                    E-421, New Ashok Nagar,<br />
                    Delhi-110096
                  </address>
                </div>
              </div>
