...
//       { src: "/cargo-plane.png", alt: "Cargo plane on runway" },
//       { src: "/delivery-boy.png", alt: "High‑capacity logistics warehouse" },
//     ],
//     []
//   );
...
// // Use compact layout (mobile + tablet) below lg (<= 1023px)
...
//         srcMobile: "/container-ship-mobile.png", // optional portrait/mobile-tablet version
//         alt: "Container ship at sea",
//       },
//       {
//         src: "/cargo-plane.png",
...
//                 fill
//                 priority={i === 0}
//                 // Fit on mobile/tablet, cover on desktop
...
//       {/* Compact (mobile+tablet) content: heading at top INSIDE image, stacked CTAs near bottom */}
//       <div className="pointer-events-none absolute inset-x-0 top-0 lg:hidden">
//         <div className="mx-auto max-w-7xl px-4 pt-4 flex flex-col  justify-center items-center">
//           <motion.h1
//             className="pointer-events-auto bg-gradient-to-r from-sky-300 via-sky-600 to-sky-800 bg-clip-text text-transparent text-3xl font-extrabold leading-tight sm:text-4xl mt-10 text-center"
...
//       <div className="pointer-events-none absolute inset-x-0 bottom-16 lg:hidden flex justify-center items-center">
